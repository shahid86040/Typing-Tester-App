...
let evaluateText = (textEntered , originalText , partialText) => {
    if(textEntered === ''){
        ...
        if(textEntered === originalText){
            applyColors('limegreen'); // apply green color border
            clearInterval(interval); // stop the timer
            congratsSection.style.display = 'block'; // to display the congrats section
            congratsSound.play(); // play an audio file
        }
        else{
...
let clearAllFields = () => {
    ...
    congratsSection.style.display = 'none'; // to display the congrats section
};
